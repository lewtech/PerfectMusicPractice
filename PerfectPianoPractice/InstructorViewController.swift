...
class InstructorViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,RecordTableViewCellDelegate{
    ...
    override func viewDidLoad() {
        ...
        var alert = UIAlertController(title: "Instructor Only", message: "This is an area for the Music Instructor only!", preferredStyle: UIAlertControllerStyle.Alert)
        alert.addAction(UIAlertAction(title: "I am the Instructor", style: UIAlertActionStyle.Default, handler: nil))
        alert.addAction(UIAlertAction(title: "I am the student", style: .Cancel, handler: { action in
            switch action.style{
            case .Default:
                println("default")

            case .Cancel:
                self.performSegueWithIdentifier("studentPushSegue", sender: self)
